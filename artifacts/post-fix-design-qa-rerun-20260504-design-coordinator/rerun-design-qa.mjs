...
const artifactDir = '/home/jaden/.openclaw/workspace/Stanley-Systems-Landing-Page/artifacts/post-fix-design-qa-rerun-20260504-design-coordinator';
...
async function runCase({ name, url, width, height, screenshot }) {
  ...
  const result = await page.evaluate(() => {
    ...
    return {
      ...
      footer: footerRect ? { height: Math.round(footerRect.height), top: Math.round(footerRect.top), text: footerText } : null,
      visualKitImages,
      warmColors,
    };
  });
