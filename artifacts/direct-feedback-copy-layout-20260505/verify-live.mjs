...
const outDir = path.resolve('artifacts/direct-feedback-copy-layout-20260505/live');
await fs.mkdir(outDir, { recursive: true });
const browser = await chromium.launch({ headless: true });
const page = await browser.newPage({ viewport: { width: 1280, height: 820 }, deviceScaleFactor: 1 });
await page.goto('https://stanley-systems.com/?verify=direct-feedback-copy-layout-live-browser', { waitUntil: 'networkidle' });
