        ...
        <section className={`${shell} pt-28 pb-12 lg:pt-32 lg:pb-16`}>
          <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
            <div>
              ...
              <div className="mt-7 flex flex-col gap-3 sm:flex-row"><Link href="/invoicing-delay-cash-flow-calculator" className={primaryButton}>Calculate Your Admin Drag <ArrowRight className="ml-2 h-4 w-4" /></Link><Link href="/ai-profit-map" className={secondaryButton}>Buy the AI Profit Map</Link></div>
            </div>
