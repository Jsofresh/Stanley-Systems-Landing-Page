...
export function SiteHeader() {
  ...
  return <header className={`fixed inset-x-0 top-0 z-[999] border-b backdrop-blur-xl transition-colors ${shell}`}>
    <div className="border-b border-current/10"><div className="mx-auto flex h-9 max-w-[92rem] items-center justify-between px-4 text-xs font-bold sm:px-6 lg:px-8"><a href="tel:+16179586372" aria-label="Call Stanley Systems at 617-958-6372" className="inline-flex min-h-8 min-w-8 items-center gap-2"><Phone className="h-3.5 w-3.5 text-[#53D986]" /><span className="hidden sm:inline">+1 (617) 958-6372</span></a><Link href="/login" className="inline-flex min-h-8 items-center">Client Login</Link></div></div>
