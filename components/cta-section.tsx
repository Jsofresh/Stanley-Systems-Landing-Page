  ...
  return (
    <section id="contact" ref={sectionRef} className="relative py-8 px-4 sm:px-6 lg:px-8 mb-32">
      <div className="relative max-w-4xl mx-auto">
        <div className="fade-in-element opacity-0 translate-y-8 transition-all duration-1000 ease-out text-center p-8 md:p-10 rounded-3xl border border-slate-200 bg-white shadow-xl">
          <h3 className="text-2xl md:text-3xl lg:text-4xl font-light text-slate-900 mb-6 text-balance leading-tight">
            Ready to transform your business's{" "}
            <span className="font-medium italic bg-gradient-to-r from-slate-900 to-slate-500 bg-clip-text text-transparent">
              customer engagement
            </span>
            ?
          </h3>
