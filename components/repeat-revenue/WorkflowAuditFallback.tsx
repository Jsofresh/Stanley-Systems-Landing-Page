  ...
  return (
    <section id="audit" data-section="audit-fallback" className="scroll-mt-[120px] bg-white px-4 py-14 sm:px-6 lg:px-8 lg:py-20">
      <div className="mx-auto grid max-w-7xl gap-8 rounded-[1.35rem] border border-[#C8D8CE] bg-[#E8F6EC] p-6 shadow-[0_18px_46px_rgba(33,51,67,0.08)] lg:grid-cols-[1fr_0.82fr] lg:items-center lg:p-9">
        <div>
          <p className="text-sm font-bold text-[#1F7A3A]">Safe first move</p>
          <h2 className="mt-4 max-w-3xl text-[2.35rem] font-semibold leading-[1.03] tracking-[-0.045em] text-[#213343] sm:text-5xl">
          ...
          <div className="mt-6 grid gap-3 rounded-2xl border border-[#B7D8C0] bg-white p-4 text-center text-sm font-extrabold text-[#213343] sm:grid-cols-4">
            <span>Pay $97</span>
            <span className="text-[#1F7A3A]">→</span>
            <span>Find the leak</span>
            <span>Choose the system</span>
            <span className="hidden text-[#1F7A3A] sm:block">→</span>
        ...
        <div className="rounded-[1.2rem] border border-[#C8D8CE] bg-white p-6 text-[#213343] shadow-[0_18px_38px_rgba(33,51,67,0.10)]">
          ...
          <div className="mt-5 grid gap-3 sm:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2">
            <div className="rounded-2xl border border-[#D5DEE8] bg-[#F8FCF9] p-4">
              ...
              <p className="mt-2 text-5xl font-extrabold tracking-[-0.06em] text-[#213343]">$97</p>
            ...
            <div className="relative rounded-2xl border border-[#B7D8C0] bg-[#E8F6EC] p-4">
              <span className="absolute right-3 top-3 rounded-full bg-[#1F7A3A] px-3 py-1 text-xs font-extrabold uppercase tracking-[0.08em] text-white">Double credit</span>
              <p className="text-sm font-bold text-[#516F90]">Yearly package</p>
              <p className="mt-2 text-5xl font-extrabold tracking-[-0.06em] text-[#213343]">$194</p>
              <p className="mt-1 text-sm font-bold text-[#124E25]">credit</p>
            </div>
          </div>
          <CTALink
