...
export const packageCards = [
  {
    ...
    description: "Best for shops whose AI Profit Map shows customer follow-up should be supported after install.",
    install: "$349 installation",
    credit: "$194 AI Profit Map credit if you start there first",
    callout: null,
    cta: "Buy the AI Profit Map",
...
export const faqItems = [
  ...
  ["Do I need the AI Profit Map first?", "Start there if you have not bought it yet. The Map shows whether follow-up is the first workflow worth installing or whether another office workflow should come first."],
