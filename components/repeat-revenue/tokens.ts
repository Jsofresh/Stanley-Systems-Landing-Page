...
export const cashflowResultPanel = {
  title: "Repeat Revenue + AI Office Installation Sprint is the stronger fix.",
...
export const packageCards = [
  {
    ...
    credit: "$197 assessment credit if you start there first",
    callout: null,
    cta: "Buy monthly",
  ...
  },
  {
    ...
    name: "Repeat Revenue + Office Workflow Monthly",
    package: bothMonthly,
  ...
  {
    badge: "Best value",
    name: "Repeat Revenue + Office Workflow Yearly",
    package: bothYearly,
...
export const faqItems = [
  ...
  ["Do I need the AI Office Map first?", "No. You can buy directly. The assessment is the smart first step if you want the numbers to show which leak should be fixed first."],
  ["How does the assessment credit work?", "The AI Office Map costs $197. Buy a monthly package after the assessment and get $197 off. Buy yearly and get $194 off."],
  ["Why buy yearly?", "Yearly saves 20%, waives installation, and doubles the assessment credit."],
  ["When should I buy both systems?", "Buy both when follow-up leaks and office workflow leaks are happening together: old customers, reviews, referrals, missed calls, slow invoices, open balances, or office chasing."],
] as const
