...
export const packageCards = [
  {
    ...
    credit: "$97 assessment credit if you start there first",
    callout: null,
    cta: "Buy monthly",
...
export const faqItems = [
  ...
  ["Do I need the Office Process Assessment first?", "No. You can buy directly. The assessment is the smart first step if you want the numbers to show which leak should be fixed first."],
  ["How does the assessment credit work?", "The Office Process Assessment costs $97. Buy a monthly package after the assessment and get $97 off. Buy yearly and get $194 off."],
