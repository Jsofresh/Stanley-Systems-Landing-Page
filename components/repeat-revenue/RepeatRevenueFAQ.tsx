    ...
    <section id="scope" data-section="faq-scope" className="scroll-mt-[120px] bg-white px-4 pb-16 pt-4 sm:px-6 lg:px-8 lg:pb-20">
      <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.78fr_1.22fr]">
        <div>
          ...
          <div className="mt-7 flex flex-col gap-3">
            <CTALink
              ...
              className="inline-flex min-h-12 items-center justify-center rounded-md bg-[#1F7A3A] px-6 py-3 text-sm font-bold text-white transition hover:bg-[#17612E]"
            >
            ...
            <CTALink
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex min-h-12 items-center justify-center rounded-md border-2 border-[#1F7A3A] px-6 py-3 text-sm font-bold text-[#213343] transition hover:bg-[#E8F6EC]"
            >
              Buy Repeat Revenue
            </CTALink>
          </div>
        ...
        <div>
            ...
            {faqItems.map(([question, answer]) => (
              <details key={question} className="group py-4">
                <summary className="flex cursor-pointer list-none items-center justify-between gap-4 text-left text-xl font-bold tracking-[-0.025em] text-[#213343]">
                  {question}
                  <span className="text-2xl text-[#1F7A3A] transition group-open:rotate-45">+</span>
                </summary>
          ...
          <div className="mt-7 rounded-[1.2rem] border border-[#D5DEE8] bg-[#F8F4EA] p-6">
            <h3 className="text-2xl font-bold tracking-[-0.035em] text-[#213343]">Plain scope</h3>
