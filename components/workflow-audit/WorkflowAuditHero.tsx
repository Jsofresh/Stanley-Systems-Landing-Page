            ...
            <div className="relative z-10 max-w-[680px]">
              ...
              <div className="mt-5 grid max-w-2xl gap-3 sm:grid-cols-2">
                ...
                <div className="rounded-2xl border border-[#cfe8d5] bg-[#f0fbf4] px-4 py-3 shadow-[0_10px_28px_rgba(21,128,61,0.08)]">
                  ...
                  <p className="mt-1 text-sm font-bold leading-6 text-[#071D3A]">Buy yearly after the assessment and the credit doubles to <span className="text-[#15803D]">$194</span>.</p>
                </div>
              </div>
            </div>
