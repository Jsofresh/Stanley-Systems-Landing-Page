          ...
          <div className="grid items-center gap-6 lg:min-h-[610px] lg:grid-cols-[minmax(0,0.78fr)_minmax(470px,0.9fr)] lg:gap-7 xl:grid-cols-[minmax(0,0.76fr)_minmax(500px,0.92fr)] xl:gap-8">
            <div className="relative z-10 max-w-[680px]">
              ...
              <div className="mt-5 flex flex-col gap-3 sm:flex-row">
                <CTALink href={auditHref} kind="checkout" location="workflow_audit_hero" analyticsEvent="audit_checkout_clicked" analyticsSource="workflow_audit_page" packageId="workflow_audit" packageName="AI Profit Map" billingPeriod="one_time" ctaLabel="Buy the AI Profit Map" target="_blank" rel="noopener noreferrer" className={page.greenButton}>
              ...
              <div className="mt-5 grid max-w-2xl gap-3 sm:grid-cols-2">
                <div className="rounded-2xl border border-[#cfe8d5] bg-white px-4 py-3 shadow-[0_10px_28px_rgba(21,128,61,0.08)]">
                  ...
                  <p className="mt-1 text-sm font-bold leading-6 text-[#071D3A]">$194 credited toward your AI Office Installation Sprint.</p>
                </div>
            ...
            <aside aria-label="AI Profit Map cash collection workflow preview" className="relative mx-auto flex min-h-[520px] w-full max-w-[690px] items-center justify-center lg:min-h-[600px] lg:max-w-none lg:justify-end">
              <Image
                src="/images/uploaded/money-leak-map/money-leak-map-job-finished-office-check-invoice-sent-cash-collected.jpg"
                alt="AI Profit Map preview showing job finished, office check, invoice sent, and cash collected."
                width={1280}
                height={720}
                priority
