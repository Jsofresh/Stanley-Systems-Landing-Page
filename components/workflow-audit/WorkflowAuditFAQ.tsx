...
const faqs = [
  ...
  ["Can I buy AI Office Installation Sprint or AI Office Ops without the assessment?", "Yes. The assessment is optional. It is a credited first step for buyers who want the handoff checked before building."],
  ["How does the assessment credit work?", "If you buy AI Office Installation Sprint or AI Office Ops after the assessment, your $197 assessment fee credits toward the system. If you buy yearly, you get a $194 credit."],
