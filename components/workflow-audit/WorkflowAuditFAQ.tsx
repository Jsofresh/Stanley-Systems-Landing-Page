...
const faqs = [
  ["Is this a sales call?", "No. The Workflow Audit is a paid diagnostic. Stanley Systems reviews your current process and data, then gives you a clear map of where money, time, or follow-up is leaking."],
  ...
  ["What if I already have reminders turned on?", "That is fine. The audit checks whether those reminders cover the full handoff from job completion to billing readiness, invoice follow-up, review requests, referrals, and owner visibility."],
  ...
  ["Can I buy Cashflow Control System or Repeat Revenue System without the audit?", "Yes. The audit is optional. It is a credited first step for buyers who want the workflow inspected before building."],
  ["How does the audit credit work?", "If you buy Cashflow Control System or Repeat Revenue System after the audit, your $97 audit fee credits toward the system. If you buy yearly, you get a $194 credit."],
  ["What happens if my business is not a fit?", "Stanley Systems will tell you. If there is not enough volume, software structure, or office workflow for a system to make sense, the audit should not push you into one."],
  ["Does Stanley Systems guarantee more revenue?", "No. The audit identifies leaks and practical fixes. It does not guarantee customer payment, customer behavior, revenue, profit, or future sales."],
]
