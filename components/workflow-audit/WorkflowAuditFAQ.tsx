...
const faqs = [
  ...
  ["What if I already have reminders turned on?", "That is fine. The AI Office Map checks whether those reminders cover the full handoff from job completion to billing readiness, invoice follow-up, review requests, referrals, and what the owner needs to see."],
  ...
  ["Should I buy the AI Office Installation Sprint before the Map?", "If you have not bought the Map yet, start there. The Sprint should install workflows from your AI Office Map, not a generic package."],
  ["How does the AI Office Map credit work?", "$197 is credited toward your AI Office Installation Sprint when you move forward."],
  ["What happens if my business is not a fit?", "Stanley Systems will tell you. If there is not enough volume, software setup, or office handoff for a workflow to make sense, the AI Office Map should not push you into one."],
  ["Does Stanley Systems guarantee more revenue?", "No. The AI Office Map identifies stuck workflows and practical fixes. It does not guarantee customer payment, customer behavior, revenue, profit, or future sales."],
]
    ...
    <section data-section="faq" data-nav-theme="light" className={page.sectionTight}>
      <div className={`${page.wrap} max-w-[980px]`}>
        <div className="text-center">
          <h2 className={`${page.h2} mt-3`}>Questions owners ask before buying the AI Office Map</h2>
        </div>
