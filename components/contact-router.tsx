    ...
    <div>
      ...
      <ul className="mt-5 space-y-3 text-sm font-semibold leading-6 text-[#536173]">
        {[
          ...
          "Checkout starts the AI Office Map path. Intake gathers the work details before the review.",
...
function BoughtPanel() {
  return (
    <div>
      <h2 className="text-3xl font-semibold tracking-[-0.03em] text-[#071D3A] sm:text-4xl">Start your AI Office Map intake.</h2>
