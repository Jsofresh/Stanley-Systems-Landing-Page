...
export function FitSetup() {
  return (
    <section data-section="office workflow-fit-setup" className="bg-[#FBFCF7] py-6 sm:py-8">
      <div className={sectionShell}>
        ...
        <div className="mx-auto mt-4 max-w-5xl rounded-[1.25rem] border border-[#DDEBE2] bg-white p-4 shadow-[0_10px_24px_rgba(7,29,58,0.035)] sm:flex sm:items-center sm:justify-between sm:gap-5">
          ...
          <Link href="#office workflow-pricing" className="mt-4 inline-flex min-h-11 shrink-0 items-center rounded-full bg-[#15803D] px-5 py-2.5 text-sm font-extrabold text-white hover:bg-[#116832] sm:mt-0">See pricing options <ArrowRight className="ml-2 h-4 w-4" /></Link>
        </div>
      </div>
    </section>
  )
