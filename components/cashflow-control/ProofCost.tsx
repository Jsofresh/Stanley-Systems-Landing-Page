        ...
        <div className="mt-8 rounded-[2rem] border border-[#BFE4C8] bg-[#F4FBF5] p-5 shadow-[0_18px_48px_rgba(7,29,58,0.06)] sm:p-7">
          <div className="grid gap-5 lg:grid-cols-[1fr_auto] lg:items-center">
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              <CTALink href="/invoicing-delay-cash-flow-calculator" kind="calculator" location="office workflow_proof_calculator" analyticsEvent="calculator_cta_clicked" analyticsSource="cashflow_control_page" ctaLabel="Use the Money Leak Calculator" className="inline-flex min-h-12 items-center justify-center rounded-full border border-[#15803D] bg-white px-6 py-3 text-sm font-extrabold text-[#116832] transition hover:bg-white/80">
