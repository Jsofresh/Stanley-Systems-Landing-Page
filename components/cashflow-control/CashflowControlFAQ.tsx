const faqs = [
  ...
  ["How does the Cash Flow Assessment credit work?", "If you buy Cashflow Control or Repeat Revenue after the assessment, your $97 assessment fee credits toward the system. If you buy yearly, you get a $194 credit. The credit follows the stated assessment-credit terms and checkout path."],
