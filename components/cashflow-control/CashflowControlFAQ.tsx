const faqs = [
  ...
  ["How does the AI Office Map credit work?", "If you buy the AI Office Installation Sprint after the AI Office Map, your $197 map fee credits toward the Sprint. The credit follows the stated terms and checkout path."],
