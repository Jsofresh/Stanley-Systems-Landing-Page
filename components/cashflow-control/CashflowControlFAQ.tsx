const faqs = [
  ...
  ["What gets automated?", "Stanley Systems can automate intake routing, job-detail handoffs, billing-readiness checks, missing-info requests, invoice paths, payment follow-up, open-balance visibility, exception alerts, and admin-drag summaries. The exact automation depends on your software permissions and workflow. The AI Office Map or onboarding step decides what is safe to automate first."],
  ...
  ["How does the AI Office Map credit work?", "If you buy the AI Office Installation Sprint after the AI Office Map, your $197 map fee credits toward the AI Office Installation Sprint. The credit follows the stated terms and checkout path."],
