const faqs = [
  ...
  ["How does the AI Profit Map credit work?", "If you buy the AI Office Installation Sprint after the AI Profit Map, $194 of your $197 map fee is credited toward the AI Office Installation Sprint. The credit follows the stated terms and checkout path."],
