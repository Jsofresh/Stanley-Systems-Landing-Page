    ...
    <SectionShell
      ...
      description={
        <span className="mx-auto block max-w-[700px] text-pretty text-[15px] font-medium leading-6 text-[#334B60] sm:text-[18px] sm:leading-7">
          Estimate where revenue is slipping through the cracks. Then the Office Process Assessment turns those numbers into a clear plan.
        </span>
      }
    >
      <div
      ...
      <div className="mt-5 flex justify-center lg:mt-6">
        <CTALink
          ...
          ctaLabel="Book Office Process Assessment"
        ...
        >
          Book Office Process Assessment
