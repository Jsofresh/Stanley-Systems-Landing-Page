...
function PreviewCheckRow({ Icon, detail, label }: (typeof leakRows)[number]) {
  return (
    <div className="grid grid-cols-[38px_minmax(0,1fr)] items-center gap-3 rounded-[14px] border border-[#DDEBE2] bg-white px-3 py-2.5 shadow-[0_8px_18px_rgba(7,29,58,0.03)]">
      <div className="grid h-9 w-9 place-items-center rounded-[11px] bg-[#EFF8EB] ring-1 ring-[#D6E9DA]">
        <Icon size={36} />
      </div>
      <div className="min-w-0">
        <p className="text-[14px] font-extrabold leading-tight tracking-[-0.01em] text-[#071D3A]">{label}</p>
        <p className="mt-0.5 text-[12px] font-semibold leading-4 text-[#536A7D]">{detail}</p>
      </div>
    </div>
  )
}
...
function OutcomeTile({ children }: { children: string }) {
  ...
  return (
    <div className="rounded-[14px] border border-[#DDEBE2] bg-[#FBFEFA] px-3 py-2.5">
...
export function RevenueLeakCalculatorPreview() {
  return (
    <section
      ...
      className="relative isolate overflow-hidden bg-[#FBFCF7] px-5 py-10 text-[#071D3A] md:px-8 lg:px-10 lg:py-12"
    >
      ...
      <div className="mx-auto max-w-[78rem]">
        <div className="mx-auto max-w-[760px] text-center">
          ...
          <h2
            ...
            className="mt-4 text-balance text-[34px] font-extrabold leading-[1.02] tracking-[-0.04em] text-[#071D3A] sm:text-[46px] lg:text-[52px] [font-family:var(--font-heading)]"
          >
            Run the numbers. See where money is getting stuck.
          </h2>
          <p className="mx-auto mt-4 max-w-[690px] text-pretty text-[15px] font-medium leading-6 text-[#334B60] sm:text-[17px]">
        ...
        <Card className="mx-auto mt-7 overflow-hidden rounded-[24px] border-[#D7E7DC] bg-white/95 p-0 shadow-[0_22px_60px_rgba(7,29,58,0.08)]">
          <CardHeader className="border-b border-[#E3ECE6] bg-gradient-to-r from-white via-[#FBFEFA] to-[#F1FAEE] px-5 py-3.5 sm:px-6">
            <div className="flex items-center gap-3">
              <div className="grid h-10 w-10 shrink-0 place-items-center rounded-[13px] bg-[#EAF6E6] ring-1 ring-[#CFE6D6]">
                <MoneyLeakMapDisplayAsset size={40} priority />
              </div>
              <div className="min-w-0">
                <p className="text-[11px] font-extrabold uppercase tracking-[0.15em] text-[#087B3F]">Revenue Leak Preview</p>
                <p className="mt-0.5 text-[14px] font-semibold leading-5 text-[#42596C] sm:text-[15px]">
          ...
          <CardContent className="grid gap-0 p-0 lg:grid-cols-[0.9fr_1.1fr]">
            <div className="border-b border-[#E4EEE7] bg-[#FCFDF9] p-4 sm:p-5 lg:border-b-0 lg:border-r lg:p-6">
              <h3 className="text-[22px] font-extrabold leading-tight tracking-[-0.03em] text-[#071D3A]">
                What it checks
              </h3>
            ...
            <div className="relative overflow-hidden bg-white p-4 sm:p-5 lg:p-6">
              <div className="rounded-[20px] border border-[#D8E8DE] bg-gradient-to-b from-white to-[#F5FBF2] p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.8)] sm:p-5">
                <p className="text-[11px] font-extrabold uppercase tracking-[0.15em] text-[#087B3F]">Sample monthly revenue held back</p>
                <p
                  style={{ fontFamily: "var(--font-heading)" }}
                  className="mt-2 text-[54px] font-extrabold leading-none tracking-[-0.055em] text-[#071D3A] sm:text-[64px] [font-family:var(--font-heading)]"
                >
                  $23,450
                </p>
                <p className="mt-3 max-w-[520px] text-[14px] font-semibold leading-6 text-[#3E5568] sm:text-[15px]">
              ...
              <div className="mt-4 flex flex-col items-stretch gap-2.5 sm:items-start">
                <CTALink
                  href={calculatorHref}
                  kind="calculator"
                  ...
                  className="inline-flex min-h-[46px] items-center justify-center rounded-[12px] bg-[#08A64B] px-5 py-2.5 text-[14px] font-extrabold text-white shadow-[0_14px_28px_rgba(8,166,75,0.20)] transition hover:-translate-y-0.5 hover:bg-[#087B3F] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#08A64B] sm:px-6"
                >
