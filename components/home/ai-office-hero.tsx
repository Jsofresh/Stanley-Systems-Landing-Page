...
export function AiOfficeHero() {
  ...
  return (
    <section id="hero" data-audit-page="/" data-audit-section="home.hero" data-audit-purpose="Approved reference inspected before build: the previously approved full-bleed Stanley Systems hero preview. Canonical DESIGN.md research applied. Approved reference structure and pre-build design interpretation: preserve one full-bleed field-service photograph, a dark readability wash, oversized outcome-first type, brand-green emphasis, a visibly qualified capacity illustration, and two plain next-step CTAs. Keep the outcome and primary capacity-calculator next step inside the first phone viewport. Show that Stanley Systems multiplies the current office team rather than replacing it." data-audit-offer="Capacity Calculator | AI Office Installation Sprint" data-nav-theme="dark" data-hero-variant={variant} className="relative isolate flex min-h-[100svh] items-start overflow-hidden bg-[#071422] px-5 pb-12 pt-[17rem] text-white sm:items-center sm:px-8 sm:py-28 lg:px-10">
      ...
      <div className="mx-auto w-full max-w-[96rem]">
        <div className="relative z-10 max-w-[1360px]">
          ...
          <p className="mt-3 text-sm font-medium leading-6 text-white/78 sm:text-base">Illustration: 10 office hours per week × 52 weeks. Actual results vary by workflow.</p>
