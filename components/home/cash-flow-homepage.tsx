  ...
  return (
    <PageSection id="calculator" className="relative isolate min-h-[calc(100svh-104px)] scroll-mt-[120px] overflow-hidden bg-[#f5f9f2] py-10 text-[#071D3A] md:py-12 lg:min-h-0 lg:py-16" fullDesktop={false}>
      ...
      <div className="mx-auto grid min-h-[500px] max-w-[88rem] items-center">
        <div className="w-full max-w-[850px] px-6 py-2 sm:px-8 md:px-10 lg:ml-[5vw] lg:px-0 xl:ml-[7vw]">
          <h2 className="max-w-[850px] text-[clamp(2.35rem,4.15vw,4.15rem)] font-extrabold leading-[0.92] tracking-[-0.018em] text-[#071D3A]">
          ...
          <p className="mt-4 max-w-[640px] text-base font-semibold leading-7 text-[#35475d] sm:text-lg md:text-xl md:leading-8">Start with the free Blueprint for practical AI staff plays, or book the full Map when you want the fixes, tools, prompts, and install priority.</p>
