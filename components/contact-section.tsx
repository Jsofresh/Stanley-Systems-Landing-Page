...
const fitPoints = [
  ...
  "Paid Workflow Audit first, not a generic sales call",
        ...
        <div className="grid gap-6 lg:grid-cols-[0.92fr_1.08fr] lg:items-start">
          <div className="rounded-[2rem] border border-[#ece4d6] bg-[linear-gradient(180deg,#f9f6ef_0%,#ffffff_100%)] p-7 shadow-[0_20px_60px_rgba(15,23,42,0.06)] sm:p-8">
            ...
            <p className="mt-4 max-w-xl text-lg leading-8 text-slate-600">
              This starts the paid Workflow Audit path. If there is a real breakdown in your follow-up, calls, paperwork, or invoicing, Stanley Systems uses this to see where money may be leaking first.
            </p>
            ...
            <div className="mt-4 rounded-[1.5rem] border border-[#e8dfd0] bg-white p-5 shadow-[0_12px_30px_rgba(15,23,42,0.05)]">
              <div className="flex items-start justify-between gap-4">
                <div>
                  ...
                  <p className="mt-3 text-sm leading-7 text-slate-600 sm:text-[15px]">
                    Stanley Systems reviews what you send, looks for the revenue problem, and reaches out if there is a clear place to inspect through the Workflow Audit.
                  </p>
                </div>
                <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-[#f4efe6] text-[#15803D]">
          ...
          <div className="rounded-[2rem] border border-[#e8dfd0] bg-[#f5f1e8] p-6 shadow-[0_20px_60px_rgba(15,23,42,0.08)] sm:p-8">
            ...
            <div className="mb-6">
              ...
              <p className="mt-3 max-w-2xl text-sm leading-7 text-slate-600 sm:text-[15px]">
                Answer a few quick questions so Stanley Systems can see whether there is a real revenue problem worth auditing first.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="grid gap-5">
              ...
              >
                {submitState === "submitting" ? "Sending..." : "Apply for the Workflow Audit"}
