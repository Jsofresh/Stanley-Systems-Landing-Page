      ...
      <div className="mx-auto max-w-6xl rounded-[2rem] border border-[#ece7dc] bg-white px-6 py-8 shadow-[0_20px_60px_rgba(15,23,42,0.06)] sm:px-8 sm:py-10 lg:px-10 lg:py-12">
        <div className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr] lg:items-start">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="rounded-[1.5rem] border border-[#edd6d8] bg-[linear-gradient(180deg,#fff7f7_0%,#fdf0f1_100%)] p-5 shadow-[0_10px_24px_rgba(127,29,29,0.05)]">
            ...
            <div className="rounded-[1.5rem] border border-[#d9e7d2] bg-[#f3f8ef] p-5">
            ...
            <div className="rounded-[1.5rem] border border-[#e8e1d3] bg-white p-5 shadow-[0_12px_30px_rgba(15,23,42,0.04)] sm:col-span-2">
              <div className="text-sm font-semibold uppercase tracking-[0.14em] text-slate-500">Coastline Marine results</div>
              <div className="mt-4 grid gap-3 sm:grid-cols-3">
                <div className="rounded-2xl border border-[#e8e1d3] bg-[#fbfaf7] px-4 py-4">
                  <div className="text-xl font-semibold text-slate-900">10+ hrs/week</div>
                  <div className="mt-1 text-sm leading-6 text-slate-600">saved from admin handoffs and repeated data entry</div>
                </div>
                <div className="rounded-2xl border border-[#e8e1d3] bg-[#fbfaf7] px-4 py-4">
                  <div className="text-xl font-semibold text-slate-900">Same-day invoicing</div>
                  <div className="mt-1 text-sm leading-6 text-slate-600">instead of billing sitting for days after the job</div>
                </div>
                <div className="rounded-2xl border border-[#e8e1d3] bg-[#fbfaf7] px-4 py-4">
                  <div className="text-xl font-semibold text-slate-900">Fewer errors</div>
                  <div className="mt-1 text-sm leading-6 text-slate-600">because the office stopped retyping the same details</div>
                </div>
              </div>
            </div>
          </div>
