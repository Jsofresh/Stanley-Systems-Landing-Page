...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "That is exactly why the calculator and Workflow Audit come first. The goal is to identify whether late cash, growth money, missed follow-up, or repeat revenue should be fixed before anything gets built.",
  },
  {
