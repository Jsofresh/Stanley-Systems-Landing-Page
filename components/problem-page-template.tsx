        ...
        <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            ...
            <div className="mt-7 flex flex-col gap-3 sm:flex-row">
              <Link href="/ai-office-map" className={primaryButton}>Book the AI Office Map <ArrowRight className="ml-2 h-4 w-4" /></Link>
      ...
      <section className={`${shell} pb-12 lg:pb-16`}>
        <div className="grid gap-8 rounded-[2rem] border border-[#DDEBE2] bg-white p-6 shadow-[0_18px_54px_rgba(7,29,58,0.06)] sm:p-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
          <div>
            ...
            <Link href="/ai-office-map" className={`mt-6 ${primaryButton}`}>Book the AI Office Map</Link>
          </div>
