    ...
    <>
      ...
      <SectionShell id="audit" className="bg-[#0B1F33] text-white">
        <div className="mx-auto grid max-w-[90rem] gap-8 lg:grid-cols-[1fr_0.86fr] lg:items-center">
          <div>
            <p className="text-[13px] font-extrabold uppercase tracking-[0.18em] text-[#86efac]">Workflow Audit</p>
            ...
            <p className="mt-5 max-w-[45rem] text-lg font-medium leading-8 text-white/72">The audit maps the current office path, identifies the leak, and turns the fix into a build plan you can understand.</p>
            <div className="mt-8">
              <CTAGroup
                primary={{ href: auditHref, label: "Book the Workflow Audit" }}
          ...
          <div className="rounded-[1.8rem] border border-white/14 bg-white/[0.07] p-6">
            {[
              ...
              [Layers3, "Find the money leak", "Where work waits, gets retyped, or loses ownership."],
        ...
        <div className="mx-auto grid max-w-[90rem] gap-8 lg:grid-cols-[0.8fr_1.2fr]">
          ...
          <div className="space-y-3">
            {[
              ...
              ["Which system should we buy?", "Start with the Workflow Audit or calculator. The leak decides the first build."],
