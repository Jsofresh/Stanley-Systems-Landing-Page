...
export type PricingPackage = {
  ...
  auditCreditLabel: "Included" | "If you bought the AI Office Map first" | "After AI Office Map credit"
...
export const pricingPackages: PricingPackage[] = [
  {
    id: "workflow_audit",
    publicName: "AI Office Map",
    shortCheckoutName: "AI Office Map",
    price: 197,
    priceDisplay: "$197",
  ...
  },
  {
    ...
    waivedSetupDisplay: null,
    auditCredit: 197,
    auditCreditDisplay: "-$197",
    auditCreditLabel: "If you bought the AI Office Map first",
  ...
  },
  {
    ...
    auditCreditDisplay: "-$197",
    auditCreditLabel: "If you bought the AI Office Map first",
    firstYearCostAfterAuditCredit: 9303,
  ...
  },
  {
    ...
    setupFeeDisplay: "Starting beta install",
    waivedSetup: true,
    waivedSetupDisplay: "Scoped after AI Office Map",
    auditCredit: 197,
    auditCreditDisplay: "-$197",
    auditCreditLabel: "After AI Office Map credit",
    firstYearCostAfterAuditCredit: 3303,
