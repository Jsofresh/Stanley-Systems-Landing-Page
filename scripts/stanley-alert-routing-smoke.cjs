...
const fixtures = [
  ...
  },
  {
    ...
    title: "🟢 Office Process Assessment application",
  ...
  },
  {
    ...
    payload: {
      ...
      phone: "555-0103",
      whatBought: "Office Process Assessment",
    ...
    mustInclude: ["What bought: Office Process Assessment", "Notes: Uses &lt;field&gt; &amp; office flow"],
    mustNotInclude: ["🟢 New Stanley website form lead"],
  },
  {
