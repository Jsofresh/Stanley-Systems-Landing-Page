...
function runCase(item: SmokeCase) {
    ...
    sections: [
      {
        ...
        purpose: item.name === "public_copy_guardrail_blocks" ? "Hermes Office Process Assessment copy focused on collected revenue." : "Office Process Assessment section focused on collected revenue and owner relief.",
        offer: "Office Process Assessment",
        route: "/",
        text_path: textPath,
        screenshots,
  ...
  writeJson(textPath, {
    section_id: sectionId,
    text: "Office Process Assessment section focused on collected revenue and owner relief.",
    viewport_metadata: viewportMetadata,
  })
...
function runWrapperSmoke() {
  ...
  writeJson(packetPath, {
    ...
    run_id: manifest.run_id,
    section_id: sectionId,
    section_purpose: "Office Process Assessment section focused on collected revenue and owner relief.",
    screenshots: {
    ...
    review_prompt: {
      ...
      approved_offer_copy_guardrails: ["Office Process Assessment is the first step."],
    },
  })
  ...
  const fixtureReviewJson = JSON.stringify({
    ...
    visual_semantic_clarity_score: 9,
    visual_metaphor_coherence_score: 9,
    path_traceability_score: 9,
    approved_reference_fidelity_score: 9,
    mockup_fidelity_score: 9,
    stanley_design_alignment_score: 9,
    codex_translation_quality_score: 9,
    real_product_design_quality_score: 9,
    generic_ai_ui_risk_score: 1,
    visual_taste_preservation_score: 9,
    design_research_used_correctly: true,
    codex_inspected_approved_mockup: true,
    codex_prebuild_interpretation_present: true,
    stanley_specificity_score: 9,
    diagram_aesthetic_quality_score: 9,
    diagram_geometry_quality_score: 9,
    diagram_spacing_quality_score: 9,
    main_visual_premium_quality_score: 9,
    main_visual_hero_worthiness_score: 9,
    mobile_diagram_quality_score: 9,
    generated_asset_scaling_quality: 9,
    ...
    every_visual_element_has_business_role: true,
    arbitrary_decorative_elements_present: false,
    visually_rich_but_semantically_confusing: false,
    viewer_can_explain_visual_in_5_seconds: true,
    follows_approved_reference_structure: true,
    matches_selected_mockup_direction: true,
    could_belong_to_generic_saas_company: false,
    depends_on_designer_explanation: false,
    generated_asset_feels_raw_or_ai: false,
    central_visual_asset_is_ugly: false,
    diagram_has_awkward_proportions: false,
    diagram_has_cramped_or_forced_layout: false,
    main_visual_looks_intentionally_designed: true,
    main_visual_supports_section_hierarchy: true,
    generated_asset_text_is_baked_in: false,
    generated_asset_has_unreadable_text: false,
    visual_asset_ready_for_production_use: true,
...
function mobileQa(
  ...
  const base = {
    ...
    section: {
      ...
      h2_texts: ["Office Process Assessment"],
    },
    links: [
      {
        text: "Book an Office Process Assessment",
        href: "/contact",
    ...
    copy: {
      text: "Office Process Assessment. Find the money leaks hiding inside your office workflow. Book an Office Process Assessment.",
      h1_texts: ["Find the money leaks hiding inside your office workflow."],
      major_headlines: ["Find the money leaks hiding inside your office workflow.", "Office Process Assessment"],
    },
  }
...
function review(
  ...
  return {
    ...
    visual_semantic_clarity_score: passing ? 9 : 4,
    visual_metaphor_coherence_score: passing ? 9 : 4,
    path_traceability_score: passing ? 9 : 4,
    approved_reference_fidelity_score: passing ? 9 : 4,
    mockup_fidelity_score: passing ? 9 : 4,
    stanley_design_alignment_score: passing ? 9 : 4,
    codex_translation_quality_score: passing ? 9 : 4,
    real_product_design_quality_score: passing ? 9 : 4,
    generic_ai_ui_risk_score: passing ? 1 : 8,
    visual_taste_preservation_score: passing ? 9 : 4,
    design_research_used_correctly: passing,
    codex_inspected_approved_mockup: passing,
    codex_prebuild_interpretation_present: passing,
    stanley_specificity_score: passing ? 9 : 4,
    diagram_aesthetic_quality_score: passing ? 9 : 4,
    diagram_geometry_quality_score: passing ? 9 : 4,
    diagram_spacing_quality_score: passing ? 9 : 4,
    main_visual_premium_quality_score: passing ? 9 : 4,
    main_visual_hero_worthiness_score: passing ? 9 : 4,
    mobile_diagram_quality_score: passing ? 9 : 4,
    generated_asset_scaling_quality: passing ? 9 : 4,
    repeated_card_pattern_present: false,
    repeated_card_pattern_dominates: false,
    repeated_card_pattern_is_secondary_support: false,
