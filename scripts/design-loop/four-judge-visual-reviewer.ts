...
function buildStrategyPrompt(packet: ReviewPacket, route: string, visibleText: string, context: StanleyContext): string {
  return [
    ...
    context.markdown,
    "<<<STANLEY_CONTEXT_END>>>",
    "Strategy rubric: judge ICP alignment, offer architecture, copy rules, public language rules, result-first positioning, Cash Flow Assessment, Cash Flow Collection System, and Repeat Revenue System.",
