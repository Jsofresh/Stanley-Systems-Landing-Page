      ...
      <main className="px-4 pb-20 pt-28 sm:px-6 sm:pt-32 lg:px-8 lg:pt-36">
        <div className="mx-auto max-w-5xl">
          <div className="max-w-3xl">
            ...
            <h1 className="mt-3 text-4xl font-semibold tracking-[-0.04em] text-[#071D3A] sm:text-6xl">Tell Stanley Systems what to review before the audit.</h1>
            <p className="mt-5 text-lg leading-8 text-[#536173]">Use this after buying the Workflow Audit. The intake gives Stanley Systems enough context to review cash, follow-up, software handoffs, and the first leak worth fixing.</p>
          </div>
          ...
          <div className="mt-8 grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
            <div className="rounded-[2rem] border border-[#DDEBE2] bg-white p-6 shadow-[0_18px_48px_rgba(7,29,58,0.06)]">
              ...
              <p className="mt-4 text-sm font-semibold leading-7 text-[#536173]">Stanley Systems does not ask for your password. For the audit, you can share what is needed through screen share, exports, screenshots, or a temporary invited user. Access is limited to what is needed to find the leak and explain the fix.</p>
              <Link href="/audit-started" className="mt-6 inline-flex min-h-12 items-center justify-center rounded-full border border-[#CFE8D5] bg-[#F4FBF5] px-5 py-3 text-sm font-extrabold text-[#116832] hover:bg-white">Back to audit start</Link>
            </div>
            ...
            <div className="rounded-[2rem] border border-[#DDEBE2] bg-[#FBFEFA] p-6 shadow-[0_18px_48px_rgba(7,29,58,0.06)]">
              ...
              <a href="mailto:hello@stanley-systems.com?subject=Workflow%20Audit%20intake" className="mt-6 inline-flex min-h-13 items-center justify-center rounded-full bg-[#15803D] px-6 py-3 text-sm font-extrabold text-white hover:bg-[#116832]">Send audit intake</a>
            </div>
          </div>
        </div>
      </main>
