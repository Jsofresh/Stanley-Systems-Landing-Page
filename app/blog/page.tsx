      ...
      <main className="bg-[#F7F4EC] text-[#102033]">
        ...
        <section className="mx-auto max-w-7xl px-4 pb-10 sm:px-6 lg:px-8">
          <div className="rounded-[2rem] bg-[#071D3A] p-6 text-white sm:p-8 lg:flex lg:items-center lg:justify-between lg:gap-8">
            ...
            <Link href="/workflow-audit" className="mt-6 inline-flex min-h-12 shrink-0 items-center justify-center rounded-full bg-white px-6 py-3 text-sm font-extrabold text-[#116832] transition hover:bg-[#F4FBF5] lg:mt-0">Get the AI Office Map</Link>
          </div>
        </section>
