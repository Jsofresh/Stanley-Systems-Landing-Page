...
const fixes = [
  ["Cashflow Control System", "Moves finished work toward billing-ready, invoice follow-up, and collected cash with fewer office chases."],
  ["Repeat Revenue System", "Turns past customers, missed calls, reviews, referrals, and seasonal follow-up into cleaner booked-work paths."],
  ["Cash Flow Assessment", "Finds the first money leak before the shop buys or builds the wrong system."],
]
      ...
      <section data-nav-theme="light" className="px-4 pb-16 pt-10 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          ...
          <section data-nav-theme="light" className="mt-8 rounded-[2rem] border border-[#d8e8de] bg-[#071422] p-5 text-white shadow-[0_24px_80px_rgba(7,20,34,0.18)] sm:p-8">
            <div className="grid gap-8 lg:grid-cols-[0.88fr_1.12fr] lg:items-center">
              <div>
                ...
                <p className="mt-4 text-base font-medium leading-7 text-[#d7e5dc]">No goofy AI visuals. No giant software migration. Just cleaner next steps around the work the marine shop already does.</p>
              </div>
          ...
          <section data-nav-theme="light" className="mt-8 rounded-[2rem] border border-[#cfe8d5] bg-[#eef9f2] p-6 text-center sm:p-8">
            ...
            <p className="mx-auto mt-3 max-w-3xl text-base font-medium leading-7 text-[#42596C]">Book the Cash Flow Assessment and find which handoff is costing the shop first.</p>
