...
const fixes = [
  ...
  ["AI Profit Map", "Finds the first admin drag before the shop buys or builds the wrong system."],
]
      ...
      <section data-nav-theme="light" className="px-4 pb-16 pt-10 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-8 rounded-[2.35rem] border border-[#d8e8de] bg-[#fffdf8] p-5 shadow-[0_24px_80px_rgba(7,29,58,0.08)] sm:p-8 lg:grid-cols-[1.05fr_0.95fr] lg:p-10">
            <div>
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                <Link href="/ai-profit-map" className="inline-flex min-h-12 items-center justify-center rounded-full bg-[#15803D] px-6 py-3 text-base font-bold text-white shadow-[0_18px_42px_rgba(21,128,61,0.22)] transition hover:bg-[#116832]">
          ...
          <section data-nav-theme="light" className="mt-8 rounded-[2rem] border border-[#cfe8d5] bg-[#eef9f2] p-6 text-center sm:p-8">
            ...
            <p className="mx-auto mt-3 max-w-3xl text-base font-medium leading-7 text-[#42596C]">Buy the AI Profit Map and find which handoff is costing the shop first.</p>
            <Link href="/ai-profit-map" className="mt-6 inline-flex min-h-12 items-center justify-center rounded-full bg-[#15803D] px-6 py-3 text-base font-bold text-white transition hover:bg-[#116832]">
              Buy the AI Profit Map
              <ArrowRight className="ml-2 h-4 w-4" aria-hidden="true" />
            </Link>
          </section>
