...
const fixes = [
  ...
  ["Workflow Audit", "Finds the first money leak before the shop buys or builds the wrong system."],
]
      ...
      <section data-nav-theme="light" className="px-4 pb-16 pt-10 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          ...
          <section data-nav-theme="light" className="mt-8 rounded-[2rem] border border-[#cfe8d5] bg-[#eef9f2] p-6 text-center sm:p-8">
            ...
            <p className="mx-auto mt-3 max-w-3xl text-base font-medium leading-7 text-[#42596C]">Book the Workflow Audit and find which handoff is costing the shop first.</p>
