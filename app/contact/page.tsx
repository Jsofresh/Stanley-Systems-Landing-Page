    ...
    <>
      ...
      <main className="min-h-screen bg-[#FBFCF7] text-[#071D3A] pt-20">
        <section className="mx-auto max-w-7xl px-4 pb-4 pt-12 sm:px-6 lg:px-8 lg:pt-16">
          ...
          <p className="mt-5 max-w-3xl text-lg font-semibold leading-8 text-[#42596C]">Use the form below to send Stanley Systems the bottleneck. We will route you to the Free AI Office Blueprint, AI Office Map, AI Office Installation Sprint, or a simple fit answer.</p>
        </section>
        <ContactSection />
      </main>
      <Footer />
