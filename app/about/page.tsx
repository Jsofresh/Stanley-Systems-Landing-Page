    ...
    <>
      ...
      <main className="min-h-screen bg-[#FBFCF7] text-[#071D3A]">
        ...
        <section className={`${shell} pt-28 pb-16 lg:pt-32`}>
          ...
          <div className="mt-9 flex flex-col gap-3 sm:flex-row"><Link href="/workflow-audit" className={primary}>Book the $197 AI Office Map</Link><Link href="/invoicing-delay-cash-flow-calculator" className={secondary}>Calculate Your Admin Drag</Link></div>
        </section>
