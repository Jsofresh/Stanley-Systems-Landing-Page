      ...
      <section className="mx-auto max-w-7xl px-4 pb-16 sm:px-6 lg:px-8">
        <div className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
          ...
          <div className="rounded-[2rem] bg-[#F4FBF5] p-6 ring-1 ring-[#CFE8D5] sm:p-8">
            ...
            <Link href="/workflow-audit#assessment" className="mt-6 inline-flex min-h-12 items-center justify-center rounded-full bg-[#15803D] px-6 py-3 text-sm font-extrabold text-white transition hover:bg-[#116832]">Book the AI Office Map</Link>
          </div>
        </div>
      </section>
      </main>
