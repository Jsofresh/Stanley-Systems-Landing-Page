        ...
        <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            ...
            <div className="mt-7 flex flex-col gap-3 sm:flex-row">
              <Link href="/ai-office-map#assessment" className="inline-flex min-h-12 items-center justify-center rounded-full bg-[#15803D] px-6 py-3 text-sm font-extrabold text-white shadow-[0_16px_34px_rgba(21,128,61,0.22)] transition hover:-translate-y-0.5 hover:bg-[#116832]">Book the AI Office Map <ArrowRight className="ml-2 h-4 w-4" /></Link>
      ...
      <section className="mx-auto max-w-7xl px-4 pb-16 sm:px-6 lg:px-8">
        <div className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
          ...
          <div className="rounded-[2rem] bg-[#F4FBF5] p-6 ring-1 ring-[#CFE8D5] sm:p-8">
            ...
            <p className="mt-3 text-base font-medium leading-7 text-[#536173]">Book the AI Office Map. Stanley Systems will show where the office work is costing money and which fix should happen first.</p>
            <Link href="/ai-office-map#assessment" className="mt-6 inline-flex min-h-12 items-center justify-center rounded-full bg-[#15803D] px-6 py-3 text-sm font-extrabold text-white transition hover:bg-[#116832]">Book the AI Office Map</Link>
          </div>
        </div>
      </section>
      </main>
