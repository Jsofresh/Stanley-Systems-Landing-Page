          ...
          <div className="mt-12 grid gap-8 lg:grid-cols-[0.95fr_1.05fr]">
            ...
            <section className="rounded-[2rem] border border-[#e8dfd0] bg-white/90 p-8 shadow-[0_18px_60px_rgba(15,23,42,0.06)]">
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                ...
                <Link href="/speed-up-invoicing-for-service-businesses" className="inline-flex items-center justify-center rounded-full border border-[#d8d1c4] bg-white px-6 py-3.5 text-base font-semibold text-slate-900 transition hover:bg-[#f4efe6]">
