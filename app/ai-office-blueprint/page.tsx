      ...
      <main className="min-h-screen bg-[#FBF8F2] text-[#071D3A]">
        ...
        <section data-motion-exempt className="px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
          <div className="mx-auto max-w-7xl space-y-12">
            <section aria-labelledby="generic-blueprint-heading" className="mx-auto grid w-full overflow-hidden rounded-[2.2rem] border border-[#CFE8D5] bg-white shadow-[0_24px_74px_rgba(7,29,58,0.08)] lg:w-[86vw] lg:max-w-[1500px] lg:grid-cols-[0.78fr_1.22fr]">
            ...
            <section id="blueprint-form" className="scroll-mt-44 lg:scroll-mt-48" aria-labelledby="custom-blueprint-heading">
              <div className="mx-auto mb-6 w-full text-center lg:w-[86vw] lg:max-w-[1500px]">
                <p className="text-sm font-black uppercase tracking-[0.18em] text-[#116832]">Free thing 2</p>
                <h2 id="custom-blueprint-heading" className="mt-2 text-[2.35rem] font-black leading-[0.96] tracking-[-0.06em] text-[#071D3A] sm:text-[3.35rem]">Get the custom AI Office Blueprint.</h2>
              ...
              <div className="mx-auto w-full lg:w-[86vw] lg:max-w-[1500px]">
                <BlueprintIntakeForm />
              </div>
            </section>

            <aside className="mx-auto grid w-full gap-5 rounded-[1.75rem] border border-[#CFE8D5] bg-[#EEF8EE] p-5 sm:p-6 lg:w-[86vw] lg:max-w-[1500px] lg:grid-cols-[auto_minmax(0,1fr)_auto] lg:items-center">
