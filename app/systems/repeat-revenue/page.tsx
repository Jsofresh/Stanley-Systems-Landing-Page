...
export const metadata: Metadata = {
  ...
  description: "Repeat Revenue helps service businesses bring past customers back, ask for reviews and referrals, and keep missed calls from going cold.",
  alternates: { canonical: "https://stanley-systems.com/systems/repeat-revenue" },
}

const automations = [["Past customer reactivation", "Bring old customers back into a simple follow-up path."], ["Review asks", "Ask happy customers while the good job is still fresh."], ["Referral asks", "Give trusted customers a clean prompt to send the next lead."], ["Missed-call recovery", "Keep new demand from disappearing when the office is busy."], ["Private feedback routing", "Catch unhappy feedback before it becomes a public problem."], ["Specific revenue fixes", "Build the needed follow-up automation even if it is too specific to list publicly."]]
      ...
      <main data-nav-theme="light" className="min-h-screen overflow-hidden bg-white text-[#071D3A]">
        <section className="relative overflow-hidden bg-[#FBFCF7] pb-12 pt-[7.5rem] sm:pb-16 lg:pt-[8rem]">
          ...
          <div className={`${shell} relative grid gap-10 lg:grid-cols-[0.92fr_1.08fr] lg:items-center`}>
            <div>
              <h1 className="max-w-4xl text-[2.1rem] font-semibold leading-[0.98] tracking-[-0.045em] text-[#071D3A] sm:text-[3.1rem] lg:text-[3.7rem]">Repeat Revenue turns good work into the next job.</h1>
