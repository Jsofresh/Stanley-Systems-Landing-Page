...
export const metadata: Metadata = {
  ...
  description: "How Cashflow Control and Repeat Revenue work together inside the Stanley Systems funnel.",
  alternates: { canonical: "https://stanley-systems.com/systems/both-systems" },
}

const together = [
  "Cashflow Control gets finished work closer to invoice, payment follow-up, and collected cash.",
  "Repeat Revenue turns customers you already earned into reviews, referrals, booked work, and returned customers.",
  "Together they reduce the leak before the job is paid and after the customer is happy.",
  ...
  return (
    <>
      ...
      <main data-nav-theme="light" className="min-h-screen overflow-hidden bg-white text-[#071D3A]">
        <section className="relative overflow-hidden bg-[#FBFCF7] pb-12 pt-32 sm:pt-36 lg:pb-20 lg:pt-32">
          ...
          <div className={`${shell} relative grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-center`}>
            <div>
              <h1 className="max-w-5xl text-[2.08rem] font-semibold leading-[0.96] tracking-[-0.035em] text-[#071D3A] sm:text-[3.23rem] lg:text-[3.78rem]">Cashflow Control and Repeat Revenue work best together.</h1>
              <p className="mt-5 max-w-2xl text-lg leading-8 text-[#334B60]">Customers can choose individual automations, but most service businesses leak money in more than one place. The Cash Flow Assessment shows what should be built first.</p>
        ...
        <section className="bg-white py-14 sm:py-16">
          <div className={`${shell} grid gap-5 md:grid-cols-3`}>
            <Link href="/systems/cashflow-control" className="rounded-[1.5rem] border border-[#DDEBE2] bg-[#FBFCF7] p-6 transition hover:-translate-y-0.5 hover:border-[#15803D] hover:bg-white">
              ...
              <p className="mt-3 text-sm font-semibold leading-6 text-[#536173]">For invoices, payment follow-up, open balances, and the office handoffs between finished work and cash collected.</p>
            ...
            <div className="rounded-[1.5rem] border border-[#BFE4C8] bg-[#F4FBF5] p-6">
              ...
              <p className="mt-3 text-sm font-semibold leading-6 text-[#536173]">Install the systems your business needs most. The sprint can cover either system, both systems, or specific fixes found in the assessment.</p>
              <Link href="/workflow-audit" className={`mt-4 w-full ${greenButton}`}>Start the Assessment</Link>
            </div>
          </div>
        </section>
      </main>
