...
export const metadata: Metadata = {
  ...
  description: "See which service businesses Stanley Systems helps most and when the Office Process Assessment is a good fit.",
}
        ...
        <div className="grid gap-10 lg:grid-cols-[1fr_0.9fr] lg:items-center">
          <div>
            ...
            <div className="mt-7 flex flex-col gap-3 sm:flex-row">
              <Link href="/workflow-audit" className="inline-flex min-h-12 items-center justify-center rounded-full bg-[#15803D] px-6 py-3 text-sm font-extrabold text-white shadow-[0_16px_34px_rgba(21,128,61,0.22)] transition hover:bg-[#116832]">Get the Office Process Assessment <ArrowRight className="ml-2 h-4 w-4" /></Link>
        ...
        <div className="grid gap-8 rounded-[2rem] border border-[#DDEBE2] bg-white p-6 shadow-[0_18px_54px_rgba(7,29,58,0.06)] sm:p-8 lg:grid-cols-2">
          ...
          <div>
            ...
            <div className="mt-6 rounded-2xl bg-[#F4FBF5] p-5 ring-1 ring-[#CFE8D5]">
              <p className="text-sm font-semibold leading-6 text-[#536173]">If the team does field work, office work, billing, estimates, and repeat customer follow-up, the Office Process Assessment can show which leak matters first.</p>
            </div>
          </div>
        </div>
      </section>
